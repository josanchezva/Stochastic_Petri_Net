...
def print_statistics(spn: SPN, simulation_time):
    ...
    for transition in spn.transitions:
        print("Transition {} :\n".format(transition.label))
        print(" Mean firing rate:    {}".format(
            transition.n_times_fired/simulation_time))
        print(" Number of firings:   {}".format(transition.n_times_fired))
        print(" P(Enabled):          {}\n".format(
            transition.time_enabled/simulation_time))

    place: Place
    for place in spn.places:
        print("Place {} :\n".format(place.label))
        print(" P(Not Empty):        {}".format(
            place.time_non_empty/simulation_time))
